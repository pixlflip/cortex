...
function AdminPeople() {
  ...
  const deleteGroup = async (group: any) => { if (!confirm(`Delete group “${group.name}”? Memberships and shared-vault grants will be removed.`)) return; await api(`/groups/${encodeURIComponent(group.name)}`, { method: 'DELETE' }, csrf); await groups.reload(); await users.reload() }
