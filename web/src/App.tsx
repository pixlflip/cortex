...
function VaultPage() {
  ...
  const vaults = useLoad(() => api<{ vaults: any[]; default_vault: string | null }>('/vaults'), [])
  const selectedVault = vaultParam || vaults.data?.default_vault || undefined
